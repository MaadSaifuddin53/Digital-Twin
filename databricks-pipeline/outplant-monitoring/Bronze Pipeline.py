...
csv_path = "abfss://bronze@datalaketest010.dfs.core.windows.net/ingestion/OutplantMonitoring.csv"
...
df_cleaned.write.format("delta") \
    ...
    .saveAsTable("main.bronze.OutplantMonitoring")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM main.bronze.OutplantMonitoring    
# MAGIC
