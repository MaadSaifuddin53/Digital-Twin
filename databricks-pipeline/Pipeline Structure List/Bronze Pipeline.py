...
csv_path = "abfss://bronze@datalaketest010.dfs.core.windows.net/ingestion/StructureList.csv"
...
# MAGIC %md
# MAGIC **Normalizing Columns Names**
...
columns_to_drop = ['_c14', '_c15', '_c16','_c17','_c18','_c19','_c20','_c21','_c22','_c23','_c24','_c25','_c26']
...
df_cleaned.write.format("delta") \
    ...
    .saveAsTable("main.bronze.StructureList")

# COMMAND ----------

# %sql
# SELECT * FROM main.bronze.StructureList
