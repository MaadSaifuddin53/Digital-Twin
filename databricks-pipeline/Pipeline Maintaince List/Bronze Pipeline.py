...
csv_path = "abfss://bronze@datalaketest010.dfs.core.windows.net/ingestion/MaintenanceList.csv"
...
df_cleaned = df_cleaned.drop("_c6", "_c7")
...
df_cleaned.write.format("delta") \
    ...
    .saveAsTable("main.bronze.MaintenanceList")
